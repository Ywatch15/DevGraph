...
function AuthFormContainer({ isSignIn, onToggle, onSignIn, onSignUp, loading }) {
  return (
    <div className="mx-auto grid w-87.5 gap-2">
      {isSignIn ? (
...
export function AuthUI({
  ...
  return (
    <div className="w-full min-h-screen md:grid md:grid-cols-2">
      ...
      >
        <div className="absolute inset-x-0 bottom-0 h-25 bg-linear-to-t from-background to-transparent" />
